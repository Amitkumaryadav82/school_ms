...
// Legacy BulkStaffRequest removed; bulk upload now accepts List<Staff> directly.
...
public class StaffController {
    ...
    public ResponseEntity<BulkUploadResponse> bulkUploadStaff(@Valid @RequestBody List<Staff> staffList) {
    ...
    public ResponseEntity<BulkUploadResponse> uploadCsv(@RequestParam("file") MultipartFile file) {
        logger.info("Processing staff CSV upload");
        try {
            ...
            logger.error("Error processing CSV file: {}", e.getMessage(), e); // BulkUploadResponse doesn't have success
                                                                              // or message fields
    ...
    public ResponseEntity<?> updateEmploymentStatus(@PathVariable Long id,
     ...
     */
    private boolean isValidStatusTransition(com.school.core.model.EmploymentStatus currentStatus,
            com.school.core.model.EmploymentStatus newStatus) {
