...
public class StudentMarksDTO {
    ...
    public List<QuestionMarkDTO> getQuestionMarks() {
        return questionMarks;
    }

    public void setQuestionMarks(List<QuestionMarkDTO> questionMarks) {
    ...
    public Double getMaxTheoryMarks() {
        return maxTheoryMarks;
    }

    public void setMaxTheoryMarks(Double maxTheoryMarks) {
    ...
    public Double getMaxPracticalMarks() {
        return maxPracticalMarks;
    }

    public void setMaxPracticalMarks(Double maxPracticalMarks) {
