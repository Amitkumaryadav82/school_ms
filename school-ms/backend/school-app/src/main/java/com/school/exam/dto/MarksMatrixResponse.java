...
public class MarksMatrixResponse {
    ...
    public List<SubjectColumn> getSubjects() {
        return subjects;
    }

    public void setSubjects(List<SubjectColumn> subjects) {
    ...
    public static class StudentRow {
        ...
        public List<StudentSubjectCell> getCells() {
            return cells;
        }

        public void setCells(List<StudentSubjectCell> cells) {
            this.cells = cells;
        }
    }
