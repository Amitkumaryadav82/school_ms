...
public class MarksMatrixDTO {
    ...
    public List<SubjectCol> getSubjects() { return subjects; }
    public void setSubjects(List<SubjectCol> subjects) { this.subjects = subjects; }
    ...
    public static class SubjectCol {
        ...
        public Double getMaxTheory() { return maxTheory; }
        public void setMaxTheory(Double maxTheory) { this.maxTheory = maxTheory; }
        public Double getMaxPractical() { return maxPractical; }
        public void setMaxPractical(Double maxPractical) { this.maxPractical = maxPractical; }
    }
    ...
    public static class Cell {
        ...
        public Long getSubjectId() { return subjectId; }
        public void setSubjectId(Long subjectId) { this.subjectId = subjectId; }
        public Double getTheory() { return theory; }
        public void setTheory(Double theory) { this.theory = theory; }
