-- Seed script to create and populate grade_levels, sections, and class_sections
-- This script is PostgreSQL-specific (uses DO $$ blocks)
...
-- Create classroom combinations (grade + section) for sections A-D by default
DO $$
DECLARE
    grade_rec RECORD;
    section_rec RECORD;
