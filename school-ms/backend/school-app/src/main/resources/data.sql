...
-- ============================================================================
-- H2 DEV SEED: Library Module (books, book_issues)
-- Creates minimal tables used by the JDBC-based Library repositories
-- Safe to run on H2 with create-drop and spring.sql.init.mode=always
-- ============================================================================
...
CREATE TABLE IF NOT EXISTS book_issues (
	...
	issue_type VARCHAR(50) NOT NULL, -- Student | Staff
...
-- Seed a few demo books if table is empty
INSERT INTO books (title, author, category, status)
SELECT 'The Pragmatic Programmer', 'Andrew Hunt', 'Programming', 'Available'
WHERE NOT EXISTS (SELECT 1 FROM books);
INSERT INTO books (title, author, category, status)
SELECT 'Clean Code', 'Robert C. Martin', 'Programming', 'Available'
WHERE NOT EXISTS (SELECT 1 FROM books WHERE title='Clean Code' AND author='Robert C. Martin');
INSERT INTO books (title, author, category, status)
SELECT 'To Kill a Mockingbird', 'Harper Lee', 'Fiction', 'Available'
