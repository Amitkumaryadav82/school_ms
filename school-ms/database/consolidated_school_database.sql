...
CREATE TABLE teacher_details (
    ...
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT fk_teacher_details_staff FOREIGN KEY (staff_id) REFERENCES school_staff(id)
);
...
-- Table: timetable_substitutions (temporary teacher replacements for specific dates)
...
-- ----------------------------------------------------------------------------
-- 5.9: Subjects (Common subjects for Indian schools)
-- ----------------------------------------------------------------------------

INSERT INTO subjects (code, name, description)
SELECT 'MATH01', 'Mathematics', 'Mathematics - Core subject'
WHERE NOT EXISTS (SELECT 1 FROM subjects WHERE code = 'MATH01');

INSERT INTO subjects (code, name, description)
SELECT 'ENG01', 'English', 'English Language and Literature'
WHERE NOT EXISTS (SELECT 1 FROM subjects WHERE code = 'ENG01');

INSERT INTO subjects (code, name, description)
SELECT 'SCI01', 'Science', 'General Science (for lower grades)'
WHERE NOT EXISTS (SELECT 1 FROM subjects WHERE code = 'SCI01');

INSERT INTO subjects (code, name, description)
SELECT 'SS01', 'Social Studies', 'Social Studies / Social Science'
WHERE NOT EXISTS (SELECT 1 FROM subjects WHERE code = 'SS01');

INSERT INTO subjects (code, name, description)
SELECT 'HIN01', 'Hindi', 'Hindi Language'
WHERE NOT EXISTS (SELECT 1 FROM subjects WHERE code = 'HIN01');

INSERT INTO subjects (code, name, description)
SELECT 'PHY01', 'Physics', 'Physics (for higher grades)'
WHERE NOT EXISTS (SELECT 1 FROM subjects WHERE code = 'PHY01');

INSERT INTO subjects (code, name, description)
SELECT 'CHEM01', 'Chemistry', 'Chemistry (for higher grades)'
WHERE NOT EXISTS (SELECT 1 FROM subjects WHERE code = 'CHEM01');

INSERT INTO subjects (code, name, description)
SELECT 'BIO01', 'Biology', 'Biology (for higher grades)'
WHERE NOT EXISTS (SELECT 1 FROM subjects WHERE code = 'BIO01');

INSERT INTO subjects (code, name, description)
SELECT 'CS01', 'Computer Science', 'Computer Science / IT'
WHERE NOT EXISTS (SELECT 1 FROM subjects WHERE code = 'CS01');

INSERT INTO subjects (code, name, description)
SELECT 'PE01', 'Physical Education', 'Physical Education and Sports'
WHERE NOT EXISTS (SELECT 1 FROM subjects WHERE code = 'PE01');

INSERT INTO subjects (code, name, description)
SELECT 'HIST01', 'History', 'History'
WHERE NOT EXISTS (SELECT 1 FROM subjects WHERE code = 'HIST01');

INSERT INTO subjects (code, name, description)
SELECT 'GEO01', 'Geography', 'Geography'
WHERE NOT EXISTS (SELECT 1 FROM subjects WHERE code = 'GEO01');

INSERT INTO subjects (code, name, description)
SELECT 'ECO01', 'Economics', 'Economics (for higher grades)'
WHERE NOT EXISTS (SELECT 1 FROM subjects WHERE code = 'ECO01');

INSERT INTO subjects (code, name, description)
SELECT 'ACC01', 'Accountancy', 'Accountancy (for commerce stream)'
WHERE NOT EXISTS (SELECT 1 FROM subjects WHERE code = 'ACC01');

INSERT INTO subjects (code, name, description)
SELECT 'BUS01', 'Business Studies', 'Business Studies (for commerce stream)'
WHERE NOT EXISTS (SELECT 1 FROM subjects WHERE code = 'BUS01');
...
BEGIN
    ...
    RAISE NOTICE 'Timetable Requirements feature is ready to use!';
    RAISE NOTICE '========================================';
END $$;
